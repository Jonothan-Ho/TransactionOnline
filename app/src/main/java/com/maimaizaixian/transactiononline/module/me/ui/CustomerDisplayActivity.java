...
public class CustomerDisplayActivity extends ActionBarFourActivity implements IProductController, OnItemClickListener, OnItemDeleteListener {
    ...
    private void getData() {
        mProductService.getProductList(IProductService.MODEL_CASE, "", pageIndex);
    }

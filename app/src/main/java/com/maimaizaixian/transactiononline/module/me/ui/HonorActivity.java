...
public class HonorActivity extends ActionBarFourActivity implements IProductController,OnItemClickListener,OnItemDeleteListener{
    ...
    private void getData() {
        mProductService.getProductList(IProductService.MODEL_APTITUDE,"",pageIndex);
    }

    @Override
    public void onActionClick(View view) {
        Intent intent = new Intent(this, AddHonorActivity.class);

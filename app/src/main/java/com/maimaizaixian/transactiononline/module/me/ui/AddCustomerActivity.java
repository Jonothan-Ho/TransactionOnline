...
public class AddCustomerActivity extends ActionBarTwoActivity implements IPhotoPicker.IPhotoResult, IUploadImagesController, IProductController {
    ...
    protected int getCustomView() {
        return R.layout.activity_me_add_customer;
    }
    ...
    public void onCompleteUpload(String result) {
        mProductService.addProduct(IProductService.MODEL_CASE, mEditTitle.getText().toString().trim(), result, mEditContent.getText().toString().trim());
    }
}

...
public class SellFragment extends BaseNormalFragment implements IBusinessController, OnItemDeleteListener, HistoryPublishActivity.OnFragmentInteractionListener, OnItemClickListener {
    ...
    private void getData() {
        mBusinessService.getHistoryList(uid, IBusinessService.MODE_SELL, pageIndex);
    }

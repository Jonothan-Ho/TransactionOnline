...
public class AddHonorActivity extends ActionBarTwoActivity implements IPhotoPicker.IPhotoResult, IUploadImagesController, IProductController {
    ...
    protected int getCustomView() {
        return R.layout.activity_me_add_honor;
    }
    ...
    public void onCompleteUpload(String result) {
        mProductService.addProduct(IProductService.MODEL_APTITUDE, mEditTitle.getText().toString().trim(), result, mEditContent.getText().toString().trim());
    }
}

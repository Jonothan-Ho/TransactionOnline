...
public class LeaseFragment extends BaseNormalFragment implements IBusinessController, OnItemDeleteListener, HistoryPublishActivity.OnFragmentInteractionListener, OnItemClickListener {
    ...
    private void getData() {
        mBusinessService.getHistoryList(uid, IBusinessService.MODE_RENTOUT, pageIndex);
    }

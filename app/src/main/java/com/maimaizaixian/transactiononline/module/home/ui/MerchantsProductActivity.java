 ...
 */
public class MerchantsProductActivity extends ActionBarOneActivity implements OnItemClickListener,IProductController {
    ...
    protected void initSubView() {
        ...
        mProductService.getProductList(IProductService.MODEL_PRODUCT, id,pageIndex);
    ...
    public void click(View v, int position) {
        ...
        detailsIntent.putExtra(DetailsActivity.FLAG_HINT, " 我们的产品");

 ...
 */
public class MerchantsHonorActivity extends ActionBarOneActivity implements OnItemClickListener,IProductController {
    ...
    public void click(View v, int position) {
        ...
        detailsIntent.putExtra(DetailsActivity.FLAG_HINT, "资质荣誉");
        detailsIntent.putExtra(DetailsActivity.FLAG_DETAILS, "公司荣誉");

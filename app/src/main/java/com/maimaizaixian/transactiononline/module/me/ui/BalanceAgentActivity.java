...
public class BalanceAgentActivity extends ActionBarOneActivity implements CompoundButton.OnCheckedChangeListener {

    @ViewInject(R.id.tv_balance_money)
    private TextView mTextBalance;
    @ViewInject(R.id.tv_rewards_agent)
    private TextView mTextAgentRewards;
    ...
    @ViewInject(R.id.tv_sum_agent)
    private TextView mTextSumAgent;
    ...
    protected void initSubView() {
        ...
        mTextAgentRewards.setText(payBalance.getAgentAward()+"元");
        mTextSumRewards.setText(payBalance.getAward_sum()+"元");
        mTextSumAgent.setText((payBalance.getAgent_invite_award_sum() + payBalance.getAgent_recharge_award_sum()) + "元");
    ...
    protected int getCustomView() {
        return R.layout.activity_me_balance_agent;
    }

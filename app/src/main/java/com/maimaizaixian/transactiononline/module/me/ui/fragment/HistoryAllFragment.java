...
public class HistoryAllFragment extends BaseNormalFragment implements IBusinessController, OnItemDeleteListener, HistoryPublishActivity.OnFragmentInteractionListener, OnItemClickListener {

    public static final int REQUEST_CLOSED = 10;
    public static final int REQUEST_OPENED = 11;
    ...
    private void getData() {
        mBusinessService.getHistoryList(uid, "", pageIndex);
    }

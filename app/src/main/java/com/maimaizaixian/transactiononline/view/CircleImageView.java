...
public class CircleImageView extends ImageView {
    ...
    public void setBorderColorResource(@ColorRes int borderResource) {
        setBorderColor(getContext().getResources().getColor(borderResource));
    }
    ...
    /**
     * set up some related parameters
     */
    private void setup() {
        if (!mReady) {
            mSetupPending = true;
    ...
    private void updateShaderMatrix() {
        ...
        mShaderMatrix.postTranslate((int) (dx + 0.5f) + mDrawableRect.left, (int) (dy + 0.5) + mDrawableRect.top);
